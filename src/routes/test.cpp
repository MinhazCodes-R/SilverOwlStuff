...
// keep time to fulle speed to 0.3
//pid does the correction on its own (using gyro)
// I would be like turnmaxtime to face it somewhere
//and then use same relative argument on move encoder
